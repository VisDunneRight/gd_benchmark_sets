...
Origin Notes: 20,058 chess openings from games in a database of played online chess games. 
graph features handled: categorical nodes, layered graphs, temporal event sequence
Graph features in papers: 4
Originally found at: https://github.com/VisDunneRight/sequence_braiding/blob/master/data/chess.json
